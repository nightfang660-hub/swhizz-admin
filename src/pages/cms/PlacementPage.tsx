...
export default function PlacementPageCMS() {
    ...
    const handleSave = () => {
        toast.success("Placement Page updated successfully!");
    };
    ...
    return (
        <div className="space-y-6 max-w-[1400px] mx-auto p-6">
            <div className="flex items-center justify-between border-b pb-4">
                <div>
                    <h1 className="text-2xl font-bold font-heading text-foreground">Placement Page CMS</h1>
                    <p className="text-sm text-muted-foreground mt-0.5">Manage placement statistics, alumni network stories, and hiring partners</p>
                </div>
