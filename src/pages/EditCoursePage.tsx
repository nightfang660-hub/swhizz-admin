...
const sampleCourse = {
  ...
  subtitle: "A Practical Approach to Information Security",
  description: "Master cyber security concepts, VAPT techniques, and SOC analysis with real-time projects and hands-on labs.",
  duration: "3 Months",
  ...
  status: "Published",
  skills: [
    { id: 1, title: "Network Security", icon: "Shield" },
    { id: 2, title: "Linux Administration", icon: "Monitor" },
    { id: 3, title: "Threat Analysis", icon: "Target" },
    { id: 4, title: "SOC Monitoring", icon: "Globe" },
    { id: 5, title: "Malware Analysis", icon: "Zap" },
    { id: 6, title: "Ethical Hacking", icon: "Code" },
    { id: 7, title: "Penetration Testing", icon: "Database" },
    { id: 8, title: "Incident Response", icon: "Star" },
  ] as SkillItem[],
  modules: [
    { id: 1, number: 1, title: "Cyber Security Fundamentals", description: "Build a strong foundation.", thumbnail: "https://images.unsplash.com/photo-1563206767-5b18f218e8de?w=300&h=200&fit=crop", topics: ["Introduction to Cyber Security", "Security Policies", "Cyber Laws & Ethics", "Types of Attacks"], subModules: [] },
    { id: 2, number: 2, title: "Networking & Linux for Security", description: "Understand networks and OS.", thumbnail: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=300&h=200&fit=crop", topics: ["TCP/IP Fundamentals", "Linux Command Line", "Network Protocols", "Firewall Configuration"], subModules: [] },
    { id: 3, number: 3, title: "Vulnerability Assessment & Penetration Testing", description: "Identify and exploit vulnerabilities.", thumbnail: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=300&h=200&fit=crop", topics: ["Scanning Techniques", "OWASP Top 10", "Penetration Testing Methodology", "Reporting"], subModules: [] },
    { id: 4, number: 4, title: "Ethical Hacking & VAPT", description: "Learn offensive security.", thumbnail: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=300&h=200&fit=crop", topics: ["Reconnaissance", "Exploitation", "Post-Exploitation", "Tools: Metasploit, Burp Suite"], subModules: [] },
    { id: 5, number: 5, title: "SOC/SIEM & Incident Response", description: "Real-time SOC Analyst preparation.", thumbnail: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=300&h=200&fit=crop", topics: ["SIEM Tools", "Log Analysis", "Incident Handling", "Threat Intelligence"], subModules: [] },
  ] as ModuleItem[],
  projects: [
    { id: 1, title: "Global FinTech Ledger", description: "Production-grade banking transaction engine on AWS.", tags: ["AWS", "KAFKA"], grade: "REAL-TIME" },
    { id: 2, title: "Medical Record Grid", description: "HIPAA compliant record management for large hospitals.", tags: ["HIPAA", "SPRING BOOT"], grade: "REAL-TIME" },
    { id: 3, title: "Supply Chain Tracker", description: "End-to-end logistics monitoring with real-time mapping.", tags: ["LOGISTICS", "GOOGLE MAPS"], grade: "REAL-TIME" },
    { id: 4, title: "Airlines Booking Engine", description: "Complex seat reservation system with race condition handling.", tags: ["DISTRIBUTED SYSTEMS", "SQL"], grade: "PROFESSIONAL GRADE" },
    { id: 5, title: "Social Media Backend", description: "Scalable feed generation and notification system.", tags: ["REDIS", "POSTGRESQL"], grade: "PROFESSIONAL GRADE" },
  ] as ProjectItem[],
  projectSectionTitle: "Hands-On Growth",
  projectSectionDesc: "Project Roadmap.",
  projectLevels: ["NORMAL", "MID", "ADVANCED", "REAL-TIME"],
  whyChooseUs: [
    { id: 1, title: "Industry Expert Trainers", description: "Learn from professionals with real-world experience.", icon: "Award" },
    { id: 2, title: "100% Real-Time, Hands-On Practice", description: "No theory-only courses, everything is hands-on.", icon: "Code" },
    { id: 3, title: "Real-Time Projects & Live Attack Simulations", description: "Work on actual security scenarios.", icon: "Target" },
    { id: 4, title: "Resume Building & Mock Interview Support", description: "Get career-ready with our placement team.", icon: "Briefcase" },
    { id: 5, title: "Placement Assistance & Job Support", description: "We help you land your dream job.", icon: "TrendingUp" },
  ] as BenefitItem[],
  targetAudience: [
    { id: 1, title: "Fresh Graduates", description: "Start your cyber security career from day one.", icon: "Users" },
    { id: 2, title: "IT Professionals", description: "Upskill to transition into cyber security.", icon: "Monitor" },
    { id: 3, title: "Non-IT Folks", description: "Beginners welcome, no prior experience needed.", icon: "BookOpen" },
    { id: 4, title: "System Admins", description: "Advance your career with security expertise.", icon: "Database" },
  ] as AudienceItem[],
  stats: { rating: "4.8/5", strikeRate: "100%", partners: "200+" },
  programBenefits: [
    { id: 1, title: "Hands-On Advanced Training", description: "Practice on real tools and environments.", icon: "Code" },
    { id: 2, title: "Industry-Relevant Content", description: "Curriculum aligned with industry demands.", icon: "Target" },
    { id: 3, title: "100% Hands-on Lab Practice", description: "Dedicated lab access for all students.", icon: "Monitor" },
    { id: 4, title: "Pre-Hire Project Preparation", description: "Build portfolio-ready projects.", icon: "Briefcase" },
    { id: 5, title: "Interview Prep & Soft Skills", description: "Complete career preparation package.", icon: "Users" },
    { id: 6, title: "Placement Guarantee", description: "100% placement support guarantee.", icon: "Award" },
  ] as BenefitItem[],
  journeySteps: [
    { id: 1, step: 1, title: "Enroll & Get Onboarded", description: "Complete enrollment process" },
    { id: 2, step: 2, title: "Learn From Experts", description: "Attend live classes" },
    { id: 3, step: 3, title: "Practice in Real-Time Labs", description: "Hands-on lab sessions" },
    { id: 4, step: 4, title: "Build Real Projects", description: "Create portfolio projects" },
    { id: 5, step: 5, title: "Mock Interviews", description: "Interview preparation" },
    { id: 6, step: 6, title: "Placement Support", description: "Job assistance" },
    { id: 7, step: 7, title: "Start Your Career", description: "Launch your security career" },
  ] as JourneyStep[],
  faqs: [
    { id: 1, question: "Who can join the Cyber Security course?", answer: "Anyone with a passion for security can join. No prior coding knowledge is required." },
    { id: 2, question: "Do I need prior coding knowledge?", answer: "No, we start from basics and build up your skills gradually." },
    { id: 3, question: "Will I get real-time project experience?", answer: "Yes, all our courses include real-time projects with industry scenarios." },
    { id: 4, question: "Is placement assistance provided?", answer: "Yes, we provide 100% placement assistance with resume building and mock interviews." },
    { id: 5, question: "Are online classes available?", answer: "Yes, we offer hybrid mode with both online and offline classes." },
    { id: 6, question: "What is the course duration?", answer: "The course is 3 months with flexible batch timings." },
    { id: 7, question: "Will I get certification guidance?", answer: "Yes, we prepare you for industry certifications like CEH, CompTIA Security+." },
    { id: 8, question: "Will I get support after course completion?", answer: "Yes, lifetime access to course materials and community support." },
  ] as FAQItem[],
};
      ...
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <div className="flex items-center gap-1.5 text-xs text-muted-foreground mb-1">
            ...
            <ChevronRight className="h-3 w-3" /><span>Courses</span><ChevronRight className="h-3 w-3" /><span className="text-foreground font-medium">Edit Course</span>
          </div>
          <h1 className="text-2xl font-bold font-heading text-foreground">Course Editor</h1>
          <p className="text-sm text-muted-foreground mt-0.5">Manage all course content sections</p>
        </div>
                    ...
                    {editingModule.subModules.map((sm, smIdx) => (
                      <div key={sm.id} className="rounded-xl border border-border bg-muted/20 overflow-hidden">
                        <div className="flex items-center gap-3 px-3 py-2.5 bg-muted/40 border-b border-border">
                          <div className="h-6 w-6 rounded-md gradient-soft flex items-center justify-center text-primary text-[10px] font-bold shrink-0">{smIdx + 1}</div>
                          <input
                            value={sm.name}
                            onChange={e => {
                        ...
                        <div className="p-3 space-y-1.5">
                          ...
                          ><Plus className="h-3 w-3" /> Add Topic</button>
                        </div>
                      </div>
                    ))}
                  </div>
